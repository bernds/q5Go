...
static std::array<tutorial, 10> tutorials =
{
	...
	tutorial { QObject::tr ("Advanced Life and Death"), ":/Tutorials/sgfs/lnd2.sgf", 13 },
	tutorial { QObject::tr ("One more rule"), ":/Tutorials/sgfs/bentfour.sgf", 13 },
